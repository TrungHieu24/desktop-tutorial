...
namespace HRManagementContext.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly HRManagementContextContext _context;

        public EmployeesController(HRManagementContextContext context)
        {
            _context = context;
        }
        ...
        {
            var hRManagementContextContext = _context.Employee.Include(e => e.Department);
            return View(await hRManagementContextContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HRManagementContextContext.Employee'  is null.");
            }
            var employee = await _context.Employee.FindAsync(id);
            if (employee != null)
            {
